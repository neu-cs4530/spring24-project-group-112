...
//    */
//   public constructor(
//     { id, isPlaying, elapsedTimeSec: progress, video }: Omit<WardrobeAreaModel, 'type'>,
...
//    */
//   public updateModel({ isPlaying, elapsedTimeSec: progress, video }: WardrobeAreaModel) {
//     this._video = video;
//     this._isPlaying = isPlaying;
//     this._elapsedTimeSec = progress;
//   }
...
//     if (!width || !height) {
//       throw new Error(`Malformed wardrobe area ${name}`);
//     }
...
//       const wardrobeArea = command as WardrobeAreaUpdateCommand;
//       this.updateModel(wardrobeArea.update);
